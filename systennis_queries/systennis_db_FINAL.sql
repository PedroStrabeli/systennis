...
ADD FOREIGN KEY (id_cliente) REFERENCES tb_cliente(id_cliente) ON DELETE CASCADE
,ADD FOREIGN KEY (id_endereco) REFERENCES tb_endereco(id_endereco) ON DELETE CASCADE;
...
ADD FOREIGN KEY (id_alerta) REFERENCES tb_alerta(id_alerta) ON DELETE CASCADE
